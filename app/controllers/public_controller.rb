class PublicController < ApplicationController
  ...
  def index
    @partners = [
      ...
      { name: "42", url: "https://42.fr", reason: "Merci à l'école 42 de m'avoir ouvert les yeux sur mes possibilités" },
      ...
      { name: "dougs", url: "https://www.dougs.fr?r=ODwK1GYdji", reason: "Merci à Dougs de m'aider à gérer ma compta facilement" },
